...
namespace LibBusiness
{
    ...
    {
        public static TunnelDefaultSelectEntity selectDefaultTunnel(string tableName)
        {
            ...
            TunnelDefaultSelectEntity tunnelDefaultSelectEntity = new TunnelDefaultSelectEntity();
