    ...
    public class VentilationBLL
    {
        ...
        public static VentilationInfoEntity selectVentilationInfo(int id)
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                vEntity.TunnelID = Convert.ToInt32(ds.Tables[0].Rows[0][VentilationDbConstNames.TUNNEL_ID].ToString());
        ...
        public static bool updateVentilationInfo(VentilationInfoEntity viEntity)
        {
            ...
            sb.Append(viEntity.TunnelID + "," + VentilationDbConstNames.COORDINATE_X + "=");
