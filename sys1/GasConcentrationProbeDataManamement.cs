...
namespace _1.GasEmission
{
    public partial class GasConcentrationProbeDataManamement : BaseForm
    {
        ...
        public GasConcentrationProbeDataManamement(MainFrm mainFrm)
        {
            ...
            // 设置窗体默认属性
            FormDefaultPropertiesSetter.SetManagementFormDefaultProperties(this, Const_GE.MANAGE_GAS_CONCENTRATION_PROBE_DATA);
        ...
        private void loadGasConcentrationProbeDataInfo()
        {
            this.Invoke(new MethodInvoker(delegate
           {
               ...
               this._lblNoData.Visible = true;
               this._lblNoData.Text = "查询数据中...";
            ...
            DataSet ds = GasConcentrationProbeDataBLL.selectGasConcentrationProbeDataForPageByProbeIdAndTime(_probeId, dtTimeStart, dtTimeEnd, iStartIndex, iEndIndex);
