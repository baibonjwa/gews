    ...
    public partial class MakeContours : Form
    {
        ...
        private void FileInput_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                m_strDataFilePath = System.Windows.Forms.Application.StartupPath + "\\tempdata";
            }
        ...
        private void CB_InterpolationMethod_SelectedIndexChanged(object sender, System.EventArgs e)
        {
        ...
        private bool withIn(string file)
        {
            ...
            {
                System.Windows.Forms.MessageBox.Show("获取矿界失败！" + ex.Message);
                return false;
            }
        }
