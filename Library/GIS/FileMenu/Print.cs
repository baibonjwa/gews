...
namespace GIS.FileMenu
{
    public partial class Print : Form
    {
        ...
        private void ToolItemTLBJ_Click(object sender, EventArgs e)
        {
            LibCommonForm.AddMapLegend g = new LibCommonForm.AddMapLegend();
            g.Show();
            
        }

        private void ToolItemTLXZ_Click(object sender, EventArgs e)
        {
            LibCommonForm.SelectMapLegend g = new LibCommonForm.SelectMapLegend();
            g.Show();
        }
