...
namespace LibBusiness
{
    public class GasGushQuantityBLL
    {
        ...
        public static bool insertGasGushQuantityInfo(GasGushQuantity 
            gasGushQuantityEntity)
        {
            StringBuilder sqlStr = new StringBuilder();
            sqlStr.Append("INSERT INTO " + 
                GasGushQuantityDbConstNames.TABLE_NAME);
            ...
            sqlStr.Append(", " + 
                GasGushQuantityDbConstNames.ABSOLUTE_GAS_GUSH_QUANTITY);
            sqlStr.Append(", " + 
                GasGushQuantityDbConstNames.RELATIVE_GAS_GUSH_QUANTITY);
            sqlStr.Append(", " + 
                GasGushQuantityDbConstNames.WORKING_FACE_DAY_OUTPUT);
            sqlStr.Append(", " + GasGushQuantityDbConstNames.STOPE_DATE);
            sqlStr.Append(", " + GasGushQuantityDbConstNames.TUNNEL_ID);
            sqlStr.Append(", " + 
                GasGushQuantityDbConstNames.COAL_SEAMS_ID);
            ...
            sqlStr.Append(", '" + 
                gasGushQuantityEntity.AbsoluteGasGushQuantity + "'");
            sqlStr.Append(", '" + 
                gasGushQuantityEntity.RelativeGasGushQuantity + "'");
            sqlStr.Append(", '" + 
                gasGushQuantityEntity.WorkingFaceDayOutput + "'");
        ...
        /// <returns></returns>
        public static DataSet selectGasGushQuantityInfoForPage(int 
            iStartIndex, int iEndIndex)
        {
            StringBuilder sqlStr = new StringBuilder();
            sqlStr.Append("SELECT * FROM (");
            sqlStr.Append(" SELECT ROW_NUMBER() OVER(ORDER BY " + 
                GasGushQuantityDbConstNames.ID + ") AS rowid, *");
            sqlStr.Append(" FROM " + GasGushQuantityDbConstNames.TABLE_NAME 
                + ") AS TB");
        ...
        /// </summary>
        /// <returns>【瓦斯涌出量点】/returns>
        public static DataSet selectGasGushQuantityInfoByPK(int 
            iPrimaryKey)
        {
            StringBuilder sqlStr = new StringBuilder();
            sqlStr.Append("SELECT * FROM " + 
                GasGushQuantityDbConstNames.TABLE_NAME);
            sqlStr.Append(" WHERE " + GasGushQuantityDbConstNames.ID + 
                " = " + iPrimaryKey);
        ...
        /// <param name="gasGushQuantityEntity">【瓦斯涌出量点】实体</param>
        /// <returns>成功与否：true，false</returns>
        public static bool updateGasGushQuantityInfo(GasGushQuantity 
            gasGushQuantityEntity)
        {
            StringBuilder sqlStr = new StringBuilder();
            ...
            sqlStr.Append(" SET");
            sqlStr.Append("  " + GasGushQuantityDbConstNames.X + " = '" + 
                gasGushQuantityEntity.CoordinateX + "'");
            sqlStr.Append(", " + GasGushQuantityDbConstNames.Y + " = '" + 
                gasGushQuantityEntity.CoordinateY + "'");
            sqlStr.Append(", " + GasGushQuantityDbConstNames.Z + " = '" + 
                gasGushQuantityEntity.CoordinateZ + "'");
            sqlStr.Append(", " + 
                GasGushQuantityDbConstNames.ABSOLUTE_GAS_GUSH_QUANTITY + " = '" 
                + gasGushQuantityEntity.AbsoluteGasGushQuantity + "'");
            sqlStr.Append(", " + 
            ...
            sqlStr.Append(", " + 
                ...
                gasGushQuantityEntity.WorkingFaceDayOutput + "'");
            sqlStr.Append(", " + GasGushQuantityDbConstNames.STOPE_DATE + 
                " = '" + gasGushQuantityEntity.StopeDate + "'");
            sqlStr.Append(", " + GasGushQuantityDbConstNames.TUNNEL_ID + 
                " = '" + gasGushQuantityEntity.Tunnel + "'");
            sqlStr.Append(", " + GasGushQuantityDbConstNames.COAL_SEAMS_ID 
                + " = '" + gasGushQuantityEntity.CoalSeams + "'");
            sqlStr.Append(" WHERE " + GasGushQuantityDbConstNames.ID + 
                " = " + gasGushQuantityEntity.PrimaryKey);
        ...
        public static void gasGushQuantityPointToTxt(string 
            strExportPointPath, int coalSeamID)
        {
            SaveDBXyz2Txt.WriteXYZ(strExportPointPath, 
                GasGushQuantityDbConstNames.TABLE_NAME, 
                GasGushQuantityDbConstNames.X, GasGushQuantityDbConstNames.Y, 
                GasGushQuantityDbConstNames.ABSOLUTE_GAS_GUSH_QUANTITY, 
                coalSeamID);
        }
    }
