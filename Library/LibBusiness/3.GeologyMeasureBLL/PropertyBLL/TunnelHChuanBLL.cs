    ...
    public class TunnelHChuanBLL
    {
        ...
        private static bool setTunnelAsHChuan(int tunnelID)
        {
            ...
            string sql = "UPDATE " + TunnelInfoDbConstNames.TABLE_NAME + 
                " SET " + TunnelInfoDbConstNames.TUNNEL_TYPE + " = '" + 
                TunnelHChuanDbConstNames.TUNNEL_TYPE + "' WHERE " + 
        ...
        public static DataSet selectTunnelHChuan()
        {
            ...
            string sql = "SELECT * FROM " + 
                TunnelHChuanDbConstNames.TABLE_NAME;
        ...
        /// </summary>
        /// <returns></returns>
        public static DataSet selectTunnelHChuan(int iStartIndex, int 
            iEndIndex)
        {
            ManageDataBase db = new 
                ManageDataBase(DATABASE_TYPE.MiningSchedulingDB);
            ...
            sb.Append("SELECT ROW_NUMBER() OVER(ORDER BY " + 
                TunnelHChuanDbConstNames.ID + ") AS rowid, * ");
            sb.Append("FROM " + TunnelHChuanDbConstNames.TABLE_NAME + 
                " ) AS TB ");
