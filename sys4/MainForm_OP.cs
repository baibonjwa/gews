...
namespace sys4
{
    public partial class MainForm_OP : Form
    {
        ...
        //K1值
        private void mniK1_ItemClick(object sender, ItemClickEventArgs e)
        {
            m_currentButton = 0;

            var k1ValueManagement = new K1ValueManagement();
        ...
        //K1值
        private void mniK1Float_ItemClick(object sender, ItemClickEventArgs e)
        {
            mniK1_ItemClick(null, null);
        }
