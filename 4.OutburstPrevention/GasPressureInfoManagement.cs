...
namespace _4.OutburstPrevention
{
    public partial class GasPressureInfoManagement : BaseForm
    {
        ...
        /// 构造方法
        /// </summary>
        public GasPressureInfoManagement(MainFrm mainFrm)
        {
            InitializeComponent();
        ...
        private void loadGasPressureInfo()
        {
            ...
            if (iSelCnt > 0)
            {
                ...
                for (int i = 0; i < iSelCnt; i++)
                {
                    ...
                    {
                        cells[_iRowDetailStartIndex + i, index].Text = BasicInfoManager.getInstance().getCoalSeamById(iCoalSeamsId).CoalSeamsName;
                    }
