...
namespace LibEntity
{
    public class PreWarningResultTableEntity
    {
        ...
        /// </summary>
        public PreWarningResultTableEntityUnit[] PreWarningResultArr { get; set; }


        public static PreWarningResultTableEntity Convert2WarningResultTableEntity(PreWarningResultEntity[] results)
        {
            var tblEntRet = new PreWarningResultTableEntity();
            ...
            //综合预警结果
            var comprehensiveResult = new PreWarningResultTableEntityUnit();
            comprehensiveResult.OutburstPreWarning =
                PreWarningResultTableEntityUnit.ConvertWarningLevel2UserStr(comprehensiveResultOutburst.WarningLevel);
            comprehensiveResult.OutburstPreWarningEX = finalOutburstStr;
            comprehensiveResult.UltralimitPreWarning =
                PreWarningResultTableEntityUnit.ConvertWarningLevel2UserStr(comprehensiveResultOutOfLimit.WarningLevel);
        ...
        private static PreWarningResultTableEntityUnit Parse2WarningResultTablePart(Hashtable htOutburst,
            Hashtable htOutOfLimit, string ruleType)
        {
            var ret = new PreWarningResultTableEntityUnit();
            //突出
        ...
        private static PreWarningResultTableEntityUnit Convert2WarningResultTablePart(
            PreWarningReasonsByType reasonByTypeOutburst, PreWarningReasonsByType reasonByTypeOutOfLimit)
        {
            var ret = new PreWarningResultTableEntityUnit();
            //突出
            ret.OutburstPreWarning =
                PreWarningResultTableEntityUnit.ConvertWarningLevel2UserStr(reasonByTypeOutburst.WarningLevel);
            int nCntOutBurst = reasonByTypeOutburst.LstWarningResultDetails.Count;
            ret.OutburstPreWarningEX =
                PreWarningResultTableEntityUnit.ConvertWarningDetails2UserStr(
                    reasonByTypeOutburst.LstWarningResultDetails);
            //超限
            ret.UltralimitPreWarning =
                PreWarningResultTableEntityUnit.ConvertWarningLevel2UserStr(reasonByTypeOutOfLimit.WarningLevel);
